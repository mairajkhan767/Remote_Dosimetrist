...
export const metadata = {
  title: 'Our Process',
  description:
    'Learn about our secure, HIPAA-compliant remote access methods including Citrix, RSA SecurID, VMWare Horizon, and Face ID for connecting to your treatment planning system.',
  alternates: {
    canonical: 'https://remotedosimetrist.com/process',
  },
  openGraph: {
    title: 'Our Process | Remote Dosimetrist',
    description:
      'Secure, HIPAA-compliant remote access via Citrix, RSA SecurID, VMWare Horizon. Your data stays on your system.',
    url: 'https://remotedosimetrist.com/process',
  },
}
...
const methods = [
  ...
  },
  {
    number: '02',
    title: 'RSA SecurID',
    description: 'RSA SecurID gives highly secure VPN access to your server and treatment planning system. A user must enter a personal PIN to ensure that unsecured access is not granted.',
  ...
  },
  {
    ...
    description: 'Face ID provides a secure way to access your treatment planning system. A user must use their face or fingerprint on their device to ensure that unsecured access is not granted.',
  ...
  },
  {
    ...
    description: 'VMWare Horizon via personal password grants access to a local on-site desktop.',
      ...
      <div className="ip-section ip-section-white py-16 md:py-32 relative">
        ...
        <SectionReveal>
          <div className="max-w-[1000px] mx-auto text-center px-6 gap-6 flex flex-col items-center relative z-10">
            ...
            <h2 className="sr-item text-[#003777] text-3xl md:text-[48px] font-bold md:leading-[52px] -tracking-[1.2px]">Secure Remote Access Methods</h2>
            ...
            <p className="sr-item text-[#434961] text-base md:text-[20px] leading-[28px] md:leading-[34px] -tracking-[0.3px] max-w-[700px] mt-3">
              All accomplished through trusted, secure methods — often including two-factor authentication for remote network access.
            </p>
          </div>
        </SectionReveal>
        ...
        <SectionReveal stagger={0.12} className="max-w-[1400px] mx-auto px-6 mt-16 md:mt-24 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {methods.map((method) => (
              <div key={method.number} className="sr-item ip-card p-6 md:p-10 rounded-[24px] flex flex-col gap-6 group">
                <div className="flex items-center gap-4">
                  <div className="ip-number-badge">{method.number}</div>
                  <div className="ip-accent-line"></div>
                </div>
                <h3 className="text-[#003777] text-xl md:text-[26px] font-bold -tracking-[0.5px]">{method.title}</h3>
                <p className="text-[#434961] text-[16px] md:text-[17px] leading-[26px] md:leading-[28px] max-w-[440px]">{method.description}</p>
                <a href={method.link} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-[#003777] font-semibold text-[14px] hover:text-[#0E3CF6] transition-colors mt-auto">
                  {method.linkText} <span>→</span>
                </a>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center relative z-10">
          ...
          <SectionReveal direction="right">
            <div className="sr-item flex flex-col gap-7 relative">
              ...
              <p className="text-[#434961] text-[16px] md:text-[18px] leading-[28px] md:leading-[32px] -tracking-[0.2px] max-w-[560px]">
                Once we learn your Radiation Oncologist preferences and department requirements, we&apos;re ready to securely login and work with your pre-existing departmental dosimetry worksheets.
              </p>
            </div>
          </SectionReveal>
        </div>
      ...
      <div className="ip-section ip-section-white py-14 md:py-28 relative">
        ...
        <div className="max-w-[1400px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center relative z-10">
          <SectionReveal direction="right" className="lg:order-2" parallax>
            <div className="sr-item ip-image-wrap">
              <img src="/assets/1-2.jpg" alt="Why hire a remote dosimetrist" className="w-full object-cover h-[260px] md:h-[480px]" />
            </div>
          </SectionReveal>
          <SectionReveal direction="left" className="lg:order-1">
            <div className="sr-item flex flex-col gap-7 relative">
              <span className="ip-label">The Smart Choice</span>
              <h2 className="text-[#003777] text-2xl md:text-[38px] font-extrabold -tracking-[0.95px] leading-[1.1]">Why Hire A Remote Dosimetrist?</h2>
              <div className="ip-section-divider"></div>
              <p className="text-[#434961] text-[16px] md:text-[18px] leading-[28px] md:leading-[32px] -tracking-[0.2px] max-w-[560px]">
                While the number of cancer patients increases and the demand for professional dosimetrists remains high, it&apos;s not always feasible for smaller, rural centers to have full-time staff. Hiring a remote worker makes more sense.
              </p>
              <p className="text-[#434961] text-[16px] md:text-[18px] leading-[28px] md:leading-[32px] -tracking-[0.2px] max-w-[560px]">
                Remote treatment planning can be cost-effective for many organizations while allowing for steady patient growth — without affecting your bottom line.
              </p>
