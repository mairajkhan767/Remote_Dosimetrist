...
export const metadata = {
  title: 'Our Plans',
  description:
    'Expert treatment planning for every modality — 3D Plans, IMRT, VMAT, SBRT/SABR, and Brachytherapy. Delivered with precision and overnight turnaround.',
  alternates: {
    canonical: 'https://remotedosimetrist.com/plans',
  },
  openGraph: {
    title: 'Our Plans | Remote Dosimetrist',
    description:
      '3D Plans, IMRT, VMAT, SBRT, and Brachytherapy planning with overnight turnaround. Expert remote dosimetry services.',
    url: 'https://remotedosimetrist.com/plans',
  },
  keywords: [
    '3D radiation plans',
    'IMRT planning',
        ...
        <SectionReveal>
          <div className="max-w-[1000px] mx-auto text-center px-6 gap-6 flex flex-col items-center relative z-10">
            ...
            <p className="sr-item text-[#434961] text-base md:text-[20px] leading-[28px] md:leading-[34px] -tracking-[0.3px] max-w-[740px] mt-3">
              Our skillset includes all types of 3D plans, IMRT plans, VMAT plans, and brachytherapy plans. We nearly always have the plan complete and ready for your oncologist&apos;s review in less than 24 hours.
            </p>
          </div>
        </SectionReveal>
      </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center">
                      <div className={isEven ? 'lg:order-1' : 'lg:order-2'}>
                        <div className="ip-image-wrap relative">
                          <img src={plan.image} alt={plan.title} className="w-full object-cover object-center h-[260px] md:h-[480px]" />
                      ...
                      <div className={`relative ${isEven ? 'lg:order-2' : 'lg:order-1'}`}>
                        <div className="relative flex flex-col gap-6">
                          ...
                          <h3 className="text-[#003777] text-2xl md:text-[38px] font-extrabold -tracking-[0.95px] leading-[1.1]">{plan.title}</h3>
                          <p className="text-[#434961] text-[16px] md:text-[18px] leading-[28px] md:leading-[32px] -tracking-[0.2px] max-w-[560px]">{plan.text}</p>
                        </div>
                      </div>
                    </div>
                  </div>
